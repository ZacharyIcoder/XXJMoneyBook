...
@interface BlueCralishMonthHIstoryViewController () <UITableViewDataSource>
...
@implementation BlueCralishMonthHIstoryViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    BlueCralishAllHistoryTableViewCell *cell = [self.dayTableView dequeueReusableCellWithIdentifier:@"dayAccountCell" forIndexPath:indexPath];
