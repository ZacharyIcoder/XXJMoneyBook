...
#import "BlueCralishAddTypeCollectionViewCell.h"
#import "UIViewController+BackButtonHandler.h"

@interface BlueCralishAddTypeViewController () <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
@implementation BlueCralishAddTypeViewController
- (NSString *)incomeType {
    if (!_incomeType) {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    BlueCralishAddTypeCollectionViewCell *cell = [self.typeCollectionView dequeueReusableCellWithReuseIdentifier:@"typeImageCell" forIndexPath:indexPath];
    // 得到相應名稱(路徑)的圖片，
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    BlueCralishAddTypeCollectionViewCell *cell = (BlueCralishAddTypeCollectionViewCell *)[self.typeCollectionView cellForItemAtIndexPath:indexPath];
