...
#import "BlueCralishAllHistoryViewController.h"
#import <CoreData/CoreData.h>
#import "AppDelegate.h"
#import "Account.h"
#import "BlueCralishAllHistoryTableViewCell.h"
#import "BlueCralishMonthHIstoryViewController.h"
#import "UIColor+Hex.h"

@interface BlueCralishAllHistoryViewController () <UITableViewDataSource>
...
@implementation BlueCralishAllHistoryViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    BlueCralishAllHistoryTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"monthAccountCell" forIndexPath:indexPath];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"showMonthDetail"]) {
        if ([[segue destinationViewController] isKindOfClass:[BlueCralishMonthHIstoryViewController class]]) {
            BlueCralishMonthHIstoryViewController *viewController = [segue destinationViewController];
