...
#import "BlueCralishPieViewController.h"
#import "BlueCralishPieView.h"
#import "AppDelegate.h"
#import "Account.h"
#import "BlueCralishPieTableViewCell.h"
#import "BlueCralishTypeDetailViewController.h"
#import <CoreData/CoreData.h>
#import "UIColor+PieColor.h"
#import "UIColor+Hex.h"
#import "NSNumber+String.h"

@interface BlueCralishPieViewController () <UITableViewDataSource, BlueCralishPieViewDataSource>

@property (weak, nonatomic) IBOutlet BlueCralishPieView *pieView;
...
@implementation BlueCralishPieViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    BlueCralishPieTableViewCell *cell = [self.typeTableView dequeueReusableCellWithIdentifier:@"pieTypeCell" forIndexPath:indexPath];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"showTypeDetail"]) {
        if ([[segue destinationViewController] isKindOfClass:[BlueCralishTypeDetailViewController class]]) {
            BlueCralishTypeDetailViewController *viewController = [segue destinationViewController];
